            ...
            children: [
              ...
              Column(
                children: List.generate(
                    QuizScreenController
                        .mathQuestions[currentQuestionIndex].optionsList.length,
                    (index) => InkWell(
                          onTap: () {
                            if (selectedAnswerIndex == null) {
                              ...
                              if (selectedAnswerIndex ==
                                  QuizScreenController
                                      .mathQuestions[currentQuestionIndex]
                                      .correctAnswerIndex) {
                                rightAnswersCount++;
                              } else {
                                wrongAnswersCount++;
              ...
              InkWell(
                onTap: () {
                  if (currentQuestionIndex <
                      QuizScreenController.mathQuestions.length - 1) {
                    currentQuestionIndex++;
                    selectedAnswerIndex = null;
...
// build color
  Color buildColor(int index) {
    if (index ==
            QuizScreenController
                .mathQuestions[currentQuestionIndex].correctAnswerIndex &&
        selectedAnswerIndex != null) {
