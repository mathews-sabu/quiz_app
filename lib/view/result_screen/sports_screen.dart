            ...
            children: [
              ...
              Column(
                children: List.generate(
                    QuizScreenController.sportsQuestions[currentQuestionIndex]
                        .optionsList.length,
                    (index) => InkWell(
                          onTap: () {
                            if (selectedAnswerIndex == null) {
                              ...
                              if (selectedAnswerIndex ==
                                  QuizScreenController
                                      .sportsQuestions[currentQuestionIndex]
                                      .correctAnswerIndex) {
                                rightAnswersCount++;
                              } else {
                                wrongAnswersCount++;
              ...
              InkWell(
                onTap: () {
                  if (currentQuestionIndex <
                      QuizScreenController.sportsQuestions.length - 1) {
                    currentQuestionIndex++;
                    selectedAnswerIndex = null;
...
// build color
  Color buildColor(int index) {
    if (index ==
            QuizScreenController
                .sportsQuestions[currentQuestionIndex].correctAnswerIndex &&
        selectedAnswerIndex != null) {
